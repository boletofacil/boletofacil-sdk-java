...
public class ChargeTest extends AbstractTest {
    ...
    public void constructorAndAttributes() {
        ...
        Assert.assertNull(obj.getTotalAmount());
        ...
        obj.setTotalAmount(BigDecimal.valueOf(Double.MAX_VALUE));
        ...
        Assert.assertEquals(BigDecimal.valueOf(Double.MAX_VALUE), obj.getTotalAmount());
    ...
    public void toStringTest() {
        ...
        Assert.assertEquals("description: Charge description" + newLine() +
                            ...
                            "totalAmount: 1.7976931348623157E+308" + newLine() +
